...
(function ($, undefined) {
	...
	AbstractSelect2 = ( function () {
		...
		// abstract
		function AbstractSelect2 (opts) {
			var results, search, resultsSelector = ".select2-results", disabled, readonly;

			// prepare options
			opts = this.prepareOpts( opts );
			this.opts = opts;
		...
		// abstract
		AbstractSelect2.prototype.optionToData = function(element) {
		...
		// abstract
		AbstractSelect2.prototype.triggerSelect = function(data) {
		 ...
		 */
			// abstract
		AbstractSelect2.prototype.triggerChange = function (details) {
		...
		//abstract
		AbstractSelect2.prototype.isInterfaceEnabled = function() {
			return this.enabledInterface === true;
		};

		// abstract
		AbstractSelect2.prototype.enableInterface = function() {
		...
		// abstract
		AbstractSelect2.prototype.enable = function(enabled) {
		...
		// abstract
		AbstractSelect2.prototype.readonly = function(enabled) {
		...
		// abstract
		AbstractSelect2.prototype.positionDropdown = function() {
		...
		// abstract
		AbstractSelect2.prototype.shouldOpen = function() {
			var event;
		...
		// abstract
		AbstractSelect2.prototype.clearDropdownAlignmentPreference = function() {
		 ...
		 */
			// abstract
		AbstractSelect2.prototype.opening = function() {
		...
		//abstract
		AbstractSelect2.prototype.getMaximumSelectionSize = function() {
		...
		// abstract
		AbstractSelect2.prototype.findHighlightableChoices = function() {
		...
		// abstract
		AbstractSelect2.prototype.countSelectableResults = function() {
		 ...
		 */
		AbstractSelect2.prototype.tokenize = function() {
		 ...
		 */
			// abstract
		AbstractSelect2.prototype.updateResults = function (initial, showAll) {
		...
		// abstract
		AbstractSelect2.prototype.selectHighlighted = function (options) {
		 ...
		 */
			// abstract
		AbstractSelect2.prototype.initContainerWidth = function () {
	...
	SingleSelect2 = ( function (_super) {
		...
		function SingleSelect2 (opts) {
			SingleSelect2.__super__.constructor.call(this, opts);
		};
		...
		// single
		SingleSelect2.prototype.enableInterface = function() {
			if (_super.prototype.enableInterface.apply(this, arguments)) {
				this.focusser.prop("disabled", !this.isInterfaceEnabled());
			}
		};

		// single
		SingleSelect2.prototype.opening = function () {
			var el, range;
			_super.prototype.opening.apply(this, arguments);
		...
		SingleSelect2.prototype.close = function () {
			if (!this.opened()) return;
			_super.prototype.close.apply(this, arguments);
		...
		SingleSelect2.prototype.cancel = function () {
			_super.prototype.cancel.apply(this, arguments);
			this.focusser.removeAttr("disabled");
			this.focusser.focus();
		};
		...
		// single
		SingleSelect2.prototype.clear = function(triggerChange) {
		...
		SingleSelect2.prototype.prepareOpts = function () {
			var opts = _super.prototype.prepareOpts.apply(this, arguments),
				self=this;
		...
		// single
		SingleSelect2.prototype.getPlaceholder = function() {
			...
			return _super.prototype.getPlaceholder.apply(this, arguments);
		};
		...
		// single
		SingleSelect2.prototype.postprocessResults = function (data, initial, noHighlightUpdate) {
		...
		// single
		SingleSelect2.prototype.showSearch = function(showSearchInput) {
		...
		// single
		SingleSelect2.prototype.onSelect = function (data, options) {
		...
		// single
		SingleSelect2.prototype.data = function(value, triggerChange) {
			var data;
	...
	MultiSelect2 = ( function (_super) {
		...
		function MultiSelect2 (opts) {
			MultiSelect2.__super__.constructor.call(this, opts);
		};
		...
		MultiSelect2.prototype.selectChoice = function (choice) {
		...
		// multi
		MultiSelect2.prototype.enableInterface = function() {
			if (_super.prototype.enableInterface.apply(this, arguments)) {
		...
		// multi
		MultiSelect2.prototype.opening = function () {
		...
		// multi
		MultiSelect2.prototype.tokenize = function() {
		...
		// multi
		MultiSelect2.prototype.onSelect = function (data, options) {
		...
		// multi
		MultiSelect2.prototype.postprocessResults = function (data, initial, noHighlightUpdate) {
			var val = this.getVal(),
		...
		// multi
		MultiSelect2.prototype.getMaxSearchWidth = function() {
		...
		// multi
		MultiSelect2.prototype.buildChangeDetails = function (old, current) {
		...
		// multi
		MultiSelect2.prototype.val = function (val, triggerChange) {
		...
		// multi
		MultiSelect2.prototype.onSortStart = function() {
			if (this.select) {
		...
		// multi
		MultiSelect2.prototype.onSortEnd = function() {
		...
		// multi
		MultiSelect2.prototype.data = function(values, triggerChange) {
	...
	$.fn.select2 = function () {
		...
		this.each(function () {
			if (args.length === 0 || typeof(args[0]) === "object") {
				...
				select2 = multiple ? new MultiSelect2(opts) : new SingleSelect2(opts);
	...
	window.Select2 = {
		...
		"properties": {
			defaults: $.fn.select2.defaults,
			ajaxDefaults: $.fn.select2.ajaxDefaults
		}
	};
